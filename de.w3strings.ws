...
function _test_verifyW3strings() : int {
    ...
    if (!assertTrue(GetLocStringById(2110992013) == "Frostwiderstund", "w3string.byId: 2110992013")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992022) == "Dauer des magisches Geschützes", "w3string.byId: 2110992022")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992023) == "Aufladungen des magisches Geschützes ", "w3string.byId: 2110992023")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992024) == "Schaden des magisches Geschützes", "w3string.byId: 2110992024")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992058) == "Schadenswiderstandsreduktion gegen Bestien", "w3string.byId: 2110992058")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992059) == "Schadenswiderstandsreduktion gegen Verfluchte", "w3string.byId: 2110992059")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992060) == "Schadenswiderstandsreduktion gegen Drakoniden", "w3string.byId: 2110992060")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992061) == "Schadenswiderstandsreduktion gegen Menschen", "w3string.byId: 2110992061")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992062) == "Schadenswiderstandsreduktion gegen Hybriden", "w3string.byId: 2110992062")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992063) == "Schadenswiderstandsreduktion gegen Insektoiden", "w3string.byId: 2110992063")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992064) == "Schadenswiderstandsreduktion gegen Konstrukte", "w3string.byId: 2110992064")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992065) == "Schadenswiderstandsreduktion gegen Nekrophagen", "w3string.byId: 2110992065")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992066) == "Schadenswiderstandsreduktion gegen Relikte", "w3string.byId: 2110992066")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992067) == "Schadenswiderstandsreduktion gegen Geister", "w3string.byId: 2110992067")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992068) == "Schadenswiderstandsreduktion gegen Ogroiden", "w3string.byId: 2110992068")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992069) == "Schadenswiderstandsreduktion gegen Vampire", "w3string.byId: 2110992069")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992125) == "Schaden der von Igni zugefügt wird reduziert außerdem dauerhaft die Rüstung des Gegners pro Treffer um $S$%. <br>Skaliert mit der Zeichenintesität. <br>Der Maximale Wert von $S$% kann nicht überschritten werden.", "w3string.byId: 2110992125")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992156) == "Gesundheitsregeneration außerhalb des Kampfs", "w3string.byId: 2110992156")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992157) == "Gesundheitsregeneration während des Kampfs", "w3string.byId: 2110992157")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992172) == "Zusätzlich zum normalen Kampftrance Zustand erhöht jeder Adrenalinpunkt die Zeichenintensität um $I$%.", "w3string.byId: 2110992172")) failed += 1;
    ...
    if (!assertTrue(GetLocStringById(2110992274) == "Fügt $I$ Punkte auf Feuerschaden und $I$ Punkte Schaden pro Sekunde auf Feuersturm.", "w3string.byId: 2110992274")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992275) == "Fügt $I$ Punkte auf den Schaden von Magisches Geschützen.", "w3string.byId: 2110992275")) failed += 1;
    if (!assertTrue(GetLocStringById(2110992276) == "Fügt $I$ Punkte auf die Schild-Schadensabsorption.", "w3string.byId: 2110992276")) failed += 1;
    ...
    if (!assertTrue(GetLocStringByKey("attribute_name_frost_resistance_perc") == "Frostwiderstund", "w3string.byKey: attribute_name_frost_resistance_perc")) failed += 1;
    ...
    if (!assertTrue(GetLocStringByKey("gm_sign_stats_alt_yrden_duration") == "Dauer des magisches Geschützes", "w3string.byKey: gm_sign_stats_alt_yrden_duration")) failed += 1;
    if (!assertTrue(GetLocStringByKey("gm_sign_stats_alt_yrden_charges") == "Aufladungen des magisches Geschützes ", "w3string.byKey: gm_sign_stats_alt_yrden_charges")) failed += 1;
    if (!assertTrue(GetLocStringByKey("gm_sign_stats_alt_yrden_damage") == "Schaden des magisches Geschützes", "w3string.byKey: gm_sign_stats_alt_yrden_damage")) failed += 1;
    ...
    if (!assertTrue(GetLocStringByKey("attribute_name_vsBeast_resist_reduction") == "Schadenswiderstandsreduktion gegen Bestien", "w3string.byKey: attribute_name_vsBeast_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsCursed_resist_reduction") == "Schadenswiderstandsreduktion gegen Verfluchte", "w3string.byKey: attribute_name_vsCursed_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsDraconide_resist_reduction") == "Schadenswiderstandsreduktion gegen Drakoniden", "w3string.byKey: attribute_name_vsDraconide_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsHuman_resist_reduction") == "Schadenswiderstandsreduktion gegen Menschen", "w3string.byKey: attribute_name_vsHuman_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsHybrid_resist_reduction") == "Schadenswiderstandsreduktion gegen Hybriden", "w3string.byKey: attribute_name_vsHybrid_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsInsectoid_resist_reduction") == "Schadenswiderstandsreduktion gegen Insektoiden", "w3string.byKey: attribute_name_vsInsectoid_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsMagicals_resist_reduction") == "Schadenswiderstandsreduktion gegen Konstrukte", "w3string.byKey: attribute_name_vsMagicals_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsNecrophage_resist_reduction") == "Schadenswiderstandsreduktion gegen Nekrophagen", "w3string.byKey: attribute_name_vsNecrophage_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsRelic_resist_reduction") == "Schadenswiderstandsreduktion gegen Relikte", "w3string.byKey: attribute_name_vsRelic_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsSpecter_resist_reduction") == "Schadenswiderstandsreduktion gegen Geister", "w3string.byKey: attribute_name_vsSpecter_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsOgre_resist_reduction") == "Schadenswiderstandsreduktion gegen Ogroiden", "w3string.byKey: attribute_name_vsOgre_resist_reduction")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vsVampire_resist_reduction") == "Schadenswiderstandsreduktion gegen Vampire", "w3string.byKey: attribute_name_vsVampire_resist_reduction")) failed += 1;
    ...
    if (!assertTrue(GetLocStringByKey("attribute_name_vitalityRegen") == "Gesundheitsregeneration außerhalb des Kampfs", "w3string.byKey: attribute_name_vitalityRegen")) failed += 1;
    if (!assertTrue(GetLocStringByKey("attribute_name_vitalityCombatRegen") == "Gesundheitsregeneration während des Kampfs", "w3string.byKey: attribute_name_vitalityCombatRegen")) failed += 1;
